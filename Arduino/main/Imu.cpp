...
//    number for SPI_MODE
//
//  For SPI, construct IMU myIMU(SPI_MODE, 10);
//  For I2C, construct IMU myIMU(I2C_MODE, 0x6B);
//
//  Default construction is I2C mode, address 0x6B.
//
//****************************************************************************//
IMU::IMU(uint8_t inputArg) : I2CAddress(0x6B) {
	I2CAddress = inputArg;
}

status_t IMU::beginCore(void) {
...
//
//****************************************************************************//
status_t IMU::readRegisterRegion(uint8_t *outputPointer , uint8_t offset, uint8_t length) {
	status_t returnError = IMU_SUCCESS;
...
//
//****************************************************************************//
status_t IMU::readRegister(uint8_t* outputPointer, uint8_t offset) {
	//Return value
	uint8_t result = 0;
	uint8_t numBytes = 1;
	status_t returnError = IMU_SUCCESS;
...
//
//****************************************************************************//
status_t IMU::readRegisterInt16(int16_t* outputPointer, uint8_t offset) {
	uint8_t myBuffer[2];
...
//
//****************************************************************************//
status_t IMU::writeRegister(uint8_t offset, uint8_t dataToWrite) {
	status_t returnError = IMU_SUCCESS;
...
//
//****************************************************************************//
LSM6DS3::LSM6DS3(uint8_t inputArg) : IMU(inputArg) {
